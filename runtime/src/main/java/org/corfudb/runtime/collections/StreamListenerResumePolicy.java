 ...
 * re-subscription upon any error. The re-subscription policy of this implementation protects against data
 * loss by immediately performing a full sync on any type of error.
 *
